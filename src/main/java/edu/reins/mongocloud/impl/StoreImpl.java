...
public class StoreImpl implements Store {
    ...
    @Override
    public synchronized <T extends Serializable> void put(final String key, final T value) {
    ...
    @Override
    public synchronized <T extends Serializable> Optional<T> get(final String key, final Class<T> clazz) {
        try {
            val v = cache.computeIfAbsent(key, k -> await(persistentState.fetch(key)));
