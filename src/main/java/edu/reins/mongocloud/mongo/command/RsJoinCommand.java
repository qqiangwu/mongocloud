...
public class RsJoinCommand {
    ...
    public void exec(final RsJoinRequest joinRequest) {
        ...
        final Document conf = getConf(master);
    ...
    private Document getConf(final InstanceHost master) {
        return commandRunner.runCommand(master, DB_CMD_GETCONF).get("config", Document.class);
    }
